...
const Jumbotron = () => {
	return (
		<div className="jumbotron bg-success mx-2 my-4 px-4 pb-5 rounded">
  ...
  <p className="lead">
    <a className="btn btn-primary btn-md" href="https://www.uefa.com/uefachampionsleague/" role="button">Call to action!</a>
  </p>
</div>
	);
};
